...
<head>
    ...
    <!-- page level styles-->
    <link rel="stylesheet" type="text/css" href="<?PHP echo base_url(); ?>asset/template/css/pages/404.css" />
...
<body>
    ...
    <div class="hgroup">
        ...
        <a href="<?PHP echo base_url(); ?>" class="btn btn-responsive btn-default button-alignment">Home
        </a>
    </div>
    <!-- global js -->
    ...
    <script src="<?PHP echo base_url(); ?>asset/template/js/404.js"></script>
