          ...
          <table id="example2" class="table table-bordered table-hover">
            ...
            <?php $sno = 1; ?>
                ...
                <tr class="tbl_view text-center" >
                    ...
                    <td>
                        <a href="#" class="is_active" data-type="select" data-pk="<?= $row->id?>" data-url="<?php echo base_url() ?>user/updateUserStatus" data-title="Select status"><?php echo $row->is_active == '1' ? 'Active' : 'Inactive' ?></a>
                    </td>
                    <td>
                        <a href="#" name="password" class="password" data-type="text" data-pk="<?= $row->id?>" data-url="<?php echo base_url() ?>user/updateUserPass" data-title="Enter new Password">********</a>
                    </td>
...
<form method="POST" id='deluser' action="<?php echo base_url() ?>user/delUser" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal cus-form" id="Add_transaction" method="POST" action="<?php echo base_url().'user/createUser' ?>"  data-parsley-validate>
                    ...
                    <!--tr>
                        <td>
                            ...
                            <input type="hidden" name="team_id" id='team_id' class="form-control input-group-sm" value = "0" required/>
                            <input type="hidden" value="0" name="team_boss" >
                        </td>
                    </tr-->
